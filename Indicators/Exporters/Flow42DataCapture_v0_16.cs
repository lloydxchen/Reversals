...
// ============================================================================
// Flow42DataCapture_v0_16
// ----------------------------------------------------------------------------
// One combined Flow.42 inspection + export indicator for NinjaTrader 8. v0.16 keeps v0.8 exporter-calculated NT volumetric bid/ask delta columns and adds chart data-quality checks, dataset-first folders, readable self-describing file names with Tick/NoTick capture token, frozen elapsed timing, and a compact navy glass HUD dashboard.
//
// IMPORTANT INSTALL NOTE
//   Save this file physically here if you want it under your Exporters folder:
//      Documents\NinjaTrader 8\bin\Custom\Indicators\Exporters\Flow42DataCapture_v0_16.cs
//
...
public enum Flow42CapturePreset_v0_16
{
    Export_FullResearch,
    DeepDiscovery_Safe,
...
public enum Flow42ExporterDeltaMode_v0_16
{
...
{
    public class Flow42DataCapture_v0_16 : Indicator
    {
        ...
        private const string DashboardLegacyTextTag = "Flow42DataCapture_v0_16_Status";
        ...
        protected override void OnStateChange()
        {
            ...
            {
                Name                     = "Flow42 Exporter Full Research v0.16";
                Description              = "Flow42 full research exporter v0.16 with dataset-first folders, chart data quality checks, NT volumetric bid/ask delta, readable self-describing file names with Tick/NoTick capture token, and compact navy glass export dashboard.";
                ...
                Preset                   = Flow42CapturePreset_v0_16.Export_FullResearch;
                ExporterDeltaMode        = Flow42ExporterDeltaMode_v0_16.AutoPreferNTVolumetricBidAsk;
        ...
        private void ApplyPreset()
        {
            ...
            if (Preset != Flow42CapturePreset_v0_16.Custom)
            {
            ...
            if (Preset == Flow42CapturePreset_v0_16.DeepDiscovery_Safe)
            {
            ...
            else if (Preset == Flow42CapturePreset_v0_16.DeepDiscovery_PrivateFieldNamesOnly)
            {
            ...
            else if (Preset == Flow42CapturePreset_v0_16.Probe_AllFlow42)
            {
                activeIndicatorFilter = DefaultFlow42IndicatorFilter();
                activeDrawKeywords = DefaultFlow42DrawKeywords();
                activeIncludeAllIndicators = false;
            ...
            else if (Preset == Flow42CapturePreset_v0_16.Probe_OneIndicator)
            {
            ...
            else if (Preset == Flow42CapturePreset_v0_16.Probe_AutomationOutputsOnly)
            {
                activeIndicatorFilter = DefaultFlow42IndicatorFilter();
                activeDrawKeywords = "";
                activeIncludeAllIndicators = false;
            ...
            else if (Preset == Flow42CapturePreset_v0_16.Probe_DrawObjectsOnly)
            {
                activeIndicatorFilter = DefaultFlow42IndicatorFilter();
                activeDrawKeywords = DefaultFlow42DrawKeywords();
                activeIncludeAllIndicators = false;
            ...
            else if (Preset == Flow42CapturePreset_v0_16.Probe_LiveVolLiqMeter)
            {
            ...
            else if (Preset == Flow42CapturePreset_v0_16.Export_FullResearch)
            {
            ...
            else if (Preset == Flow42CapturePreset_v0_16.Export_FastAllFlow42)
            {
                ...
                activeExportLiveSnapshots = false;
                activeInvokeKnownSafeMethods = false;
                // v0.16: no row cap for the fast feature export. This preset skips raw/heavy files,
            ...
            else if (Preset == Flow42CapturePreset_v0_16.Export_FullAllFlow42)
            {
            ...
            else if (Preset == Flow42CapturePreset_v0_16.Fast_InventoryOnly)
            {
                activeIndicatorFilter = DefaultFlow42IndicatorFilter();
                activeDrawKeywords = "";
                activeIncludeAllIndicators = false;
            ...
            else if (Preset == Flow42CapturePreset_v0_16.Fast_AutomationOutputsOnly)
            {
                activeIndicatorFilter = DefaultFlow42IndicatorFilter();
                activeDrawKeywords = "";
                activeIncludeAllIndicators = false;
            ...
            else if (Preset == Flow42CapturePreset_v0_16.Fast_DrawObjectsOnly)
            {
                activeIndicatorFilter = DefaultFlow42IndicatorFilter();
                activeDrawKeywords = DefaultFlow42DrawKeywords();
                activeIncludeAllIndicators = false;
            ...
            else if (Preset == Flow42CapturePreset_v0_16.OneIndicator_Fast)
            {
                activeIndicatorFilter = SingleIndicatorNameFilter;
                activeDrawKeywords = DefaultFlow42DrawKeywords();
                activeIncludeAllIndicators = false;
            ...
            else if (Preset == Flow42CapturePreset_v0_16.Export_ReversalFeatureMatrix)
            {
                activeIndicatorFilter = DefaultFlow42IndicatorFilter();
                activeDrawKeywords = DefaultFlow42DrawKeywords();
                activeIncludeAllIndicators = false;
                ...
                activeExportLiveSnapshots = false;
                activeInvokeKnownSafeMethods = false;
                // v0.16: no row cap for the reversal feature matrix export.
                activeMaxPlotRows = 0;
                activeHistoricalScanEveryNBars = 999999;
                activeRealtimeScanIntervalSeconds = 0;
                activeMaxRawSeriesColumns = 0;
        ...
        private bool TryGetNTVolumetricBidAskDelta(int barIndex, out double buyVolume, out double sellVolume, out double delta)
        {
            ...
            if (ExporterDeltaMode == Flow42ExporterDeltaMode_v0_16.Disabled || ExporterDeltaMode == Flow42ExporterDeltaMode_v0_16.Flow42VolDeltaOnly)
            {
            ...
            out string preferredSource)
        {
            ...
            if (ExporterDeltaMode == Flow42ExporterDeltaMode_v0_16.Disabled)
            {
                preferredSource = "Disabled";
                return;
            }

            if (ExporterDeltaMode == Flow42ExporterDeltaMode_v0_16.Flow42VolDeltaOnly)
            {
            ...
            if (ExporterDeltaMode == Flow42ExporterDeltaMode_v0_16.AutoPreferNTVolumetricBidAsk)
            {
                preferredBuy = flowBuy;
                preferredSell = flowSell;
                preferredDelta = flowDelta;
        ...
        private void WriteReadme()
        {
            ...
            {
                var sb = new StringBuilder();
                sb.AppendLine("Flow42DataCapture_v0_16");
                ...
                sb.AppendLine("- Physical file location can be Documents\\NinjaTrader 8\\bin\\Custom\\Indicators\\Exporters\\Flow42DataCapture_v0_16.cs.");
                sb.AppendLine("- Namespace is NinjaTrader.NinjaScript.Indicators.Exporters so it appears under the Exporters UI folder.");
                sb.AppendLine("- Flow42CapturePreset_v0_16 enum is global-scope on purpose to avoid generated-code CS0246 errors.");
                sb.AppendLine();
                sb.AppendLine("Default workflow:");
                sb.AppendLine("1. Put Flow42 indicators on the chart first.");
                sb.AppendLine("2. Add Flow42DataCapture_v0_16 LAST.");
                ...
                sb.AppendLine("  v0.16 keeps Flow42 VolDelta diagnostics plus exporter-calculated NT volumetric bid/ask delta / CVD, preferred-delta columns, chart data-quality dashboard checks, cleaner run folder names, and frozen elapsed time after final write.");
        ...
        private string SafeBarsPeriodTypeText()
        {
            try
            {
                ...
                string type = BarsPeriod.BarsPeriodType.ToString();
        ...
        private string SafeBarsFolderToken()
        {
            try
            {
                ...
                if (BarsPeriod == null)
                    ...
                    token = BarsPeriod.Value.ToString(CultureInfo.InvariantCulture) + "Min";
                else if (BarsPeriod.BarsPeriodType == BarsPeriodType.Range)
                    token = BarsPeriod.Value.ToString(CultureInfo.InvariantCulture) + "Range";
                else if (BarsPeriod.BarsPeriodType == BarsPeriodType.Tick)
                    token = BarsPeriod.Value.ToString(CultureInfo.InvariantCulture) + "Tick";
                else if (BarsPeriod.BarsPeriodType == BarsPeriodType.Second)
                    token = BarsPeriod.Value.ToString(CultureInfo.InvariantCulture) + "Sec";
                else if (BarsPeriod.BarsPeriodType == BarsPeriodType.Day)
                    token = BarsPeriod.Value.ToString(CultureInfo.InvariantCulture) + "Day";
                else
                    token = MakeSafeFolderName(SafeBarsPeriod()).Replace(" ", "");
                ...
                return MakeSafeFolderName(token);
            }
            catch
            {
...
private string BuildRunFolderName()
        {
            // v0.16: dataset details live in parent folders. The run folder is just the export timestamp.
        ...
        private string DeltaSourceQualityLabel()
        {
            ...
            if (ExporterDeltaMode == Flow42ExporterDeltaMode_v0_16.NTVolumetricBidAskOnly)
...
private string ResolveRunFolder(string root)
        ...
        private string DashboardShortWarning()
        {
            ...
            if (!IsPrimaryVolumetricBarsType() &&
                ExporterDeltaMode != Flow42ExporterDeltaMode_v0_16.Disabled &&
                ExporterDeltaMode != Flow42ExporterDeltaMode_v0_16.Flow42VolDeltaOnly)
        ...
        public Flow42CapturePreset_v0_16 Preset { get; set; }

        [NinjaScriptProperty]
        [Display(Name = "Exporter Delta Mode", Order = 1, GroupName = "0) Main")]
        public Flow42ExporterDeltaMode_v0_16 ExporterDeltaMode { get; set; }
